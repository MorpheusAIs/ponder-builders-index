export const DepositPoolAbi = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "indexed": false,
        "internalType": "struct IReferrer.ReferrerTier[]",
        "name": "tiers",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "address", "name": "distributor_", "type": "address" }
    ],
    "name": "DepositPool_init",
    "outputs": [],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "uint128", "name": "claimLockEnd_", "type": "uint128" }
    ],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "address[]", "name": "referrers_", "type": "address[]" }
    ],
    "name": "manageUsersInPrivateRewardPool",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "uint128", "name": "lastClaim", "type": "uint128" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  {
    "inputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],
    "name": "rewardPoolsProtocolDetails",
    "outputs": [
      {
        "internalType": "uint128",
        "name": "withdrawLockPeriodAfterStake",
  ...
  },
  {
    ...
    "name": "setAddressesAllowedToClaim",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  {
    "inputs": [
      { "internalType": "address", "name": "value_", "type": "address" }
    ],
    "name": "setDistributor",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "uint128",
        "name": "claimLockPeriodAfterStake_",
        "type": "uint128"
      },
      {
        "internalType": "uint128",
        "name": "claimLockPeriodAfterClaim_",
        "type": "uint128"
      },
      { "internalType": "uint256", "name": "minimalStake_", "type": "uint256" }
    ],
    "name": "setRewardPoolProtocolDetails",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
